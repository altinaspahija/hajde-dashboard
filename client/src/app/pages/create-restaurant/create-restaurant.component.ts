...
export class CreateRestaurantComponent implements OnInit {
  ...
  constructor(public companyFormBuilder: UntypedFormBuilder, private restuarantService: RestaurantsService, private router: Router) {
...
public calculateClosingHours(startingHour: number) {
  ...
  addCompany() {
    ...
    if (this.companyFormGroup.valid) {
      ...
      this.restuarantService.addRestaurant(reqBody)
