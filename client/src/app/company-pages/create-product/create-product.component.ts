...
export class CreateProductComponent implements OnInit {
  ...
  constructor(public categoryService: CategoryService,public productFormBuilder: UntypedFormBuilder, private productService: ProductService, private router:Router) {
  ...
  changeCat(e) {
    this.categoryService
      .getSubcategories(this.productFormGroup.get('category').value, "market")
      .pipe(takeUntil(this.unsubscribeAll))
      .subscribe((data) => {
