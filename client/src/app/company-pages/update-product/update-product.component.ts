...
export class UpdateProductComponent implements OnInit {
  ...
  constructor(public categoryService: CategoryService,public productFormBuilder: UntypedFormBuilder, private productService: ProductService, private router:Router, private activeRoute: ActivatedRoute, public companyCategoryService: CompanyCategoryService,  public authService: AuthService) {
      ...
      this.productService.getProduct(this.id)
        ...
        .subscribe(data => {
          ...
          this.categoryService
            .getSubcategories(data.product.categoryId, "market")
            .pipe(takeUntil(this.unsubscribeAll))
            .subscribe((data) => {
   ...
   changeCat(e) {
    ...
    this.categoryService
      .getSubcategories(this.productFormGroup.get('category').value,  this.id)
      .pipe(takeUntil(this.unsubscribeAll))
      .subscribe((data) => {
        this.subcategories = data.subcategories;
      },error =>{
